...
I initially faced an issue where the image was not displaying, which I later fixed by correcting the image path.
...
I did not blindly copy code. I understood each section before implementing it.

#Challenges Faced & How I Solved Them

The image was not visible on the page.
Solution: Checked file path and folder structure. Corrected image placement.

Initially unsure how to deploy the project.
Solution: Enabled GitHub Pages and selected correct branch.
